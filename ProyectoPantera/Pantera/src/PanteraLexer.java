...
public class PanteraLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"Break", "Do", "Continuar", "Else", "Func", "For", "If", "Then", "Len", 
			"NoneObj", "Print", "Return", "While", "TrueLiteral", "FalseLiteral", 
			"LINEA_COMENTARIO", "NUMERO", "ESPACIO", "VARIABLE", "NEWLINE"
		};
	}
	...
	public PanteraLexer(CharStream input) {
		super(input);
